...
-----------------VFF---------------------
-----------------------------------------
{   down = 5000, name = _('Smoke On'), category = {_('VFF Mods')}},
{   down = 5001, name = _('Smoke Off'), category = {_('VFF Mods')}},
{   down = 5002, name = _('Smoke Toggle'), category = {_('VFF Mods')}},
{   down = 5003, name = _('Smoke Arm'), category={_('VFF Mods')}},
